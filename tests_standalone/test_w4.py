...
from erpnext_mcp.tools import w4
...
class PureCalcEngine(W4TestCase):
    ...
    def test_deterministic(self):
        ...
        brackets = ANNUAL_BRACKETS["Single"]
        kwargs = dict(
            gross_pay=3000, pay_frequency="Biweekly",
            w4_data=w4, ytd_gross=50000, ytd_ss_withheld=3100,
            fica_config=fica, tax_table=brackets,
        )
    ...
    def test_married_filing_jointly_lower_tax(self):
        ...
        single = calculate_federal_withholding(
            5000, "Biweekly", single_w4, 0, 0, fica, ANNUAL_BRACKETS["Single"],
        )
        mfj = calculate_federal_withholding(
            5000, "Biweekly", mfj_w4, 0, 0, fica, ANNUAL_BRACKETS["Married Filing Jointly"],
        )
...
class SSWageBaseCap(W4TestCase):
    ...
    def test_under_cap(self):
        ...
        result = calculate_federal_withholding(
            5000, "Biweekly", self._default_w4_data(), 0, 0,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
    ...
    def test_at_cap_mid_year(self):
        ...
        result = calculate_federal_withholding(
            5000, "Biweekly", self._default_w4_data(), ytd, ytd * 0.062,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
...
class AdditionalMedicare(W4TestCase):
    ...
    def test_under_threshold(self):
        ...
        result = calculate_federal_withholding(
            5000, "Biweekly", self._default_w4_data(), 100000, 0,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
    ...
    def test_crossing_threshold(self):
        ...
        result = calculate_federal_withholding(
            gross, "Biweekly", self._default_w4_data(), ytd, 0,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
...
class FUTACalc(W4TestCase):
    ...
    def test_under_futa_base(self):
        ...
        result = calculate_federal_withholding(
            2000, "Biweekly", self._default_w4_data(), 0, 0,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
    ...
    def test_over_futa_base(self):
        ...
        result = calculate_federal_withholding(
            2000, "Biweekly", self._default_w4_data(), 8000, 0,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
...
class ReadTools(W4TestCase):
    ...
    def test_get_federal_tax_table(self):
        data = self.tool_data("get_federal_tax_table", {
            "tax_year": 2025,
            "filing_status": "Single",
...
class CalcToolsEndToEnd(W4TestCase):
    ...
    def test_preview_withholding(self):
        self._submit_w4()
        data = self.tool_data("preview_federal_withholding", {
    ...
    def test_calculate_payroll_taxes(self):
        self._submit_w4()
        data = self.tool_data("calculate_payroll_taxes", {
            "employee": "HR-EMP-00001",
            "gross_pay": 3000,
            "pay_frequency": "Biweekly",
        })
    ...
    def test_no_w4_errors(self):
        text = self.tool_error("preview_federal_withholding", {
            "employee": "HR-EMP-00001",
            "gross_pay": 2500,
            "pay_frequency": "Biweekly",
        })
...
class EdgeCases(W4TestCase):
    ...
    def test_zero_gross(self):
        ...
        result = calculate_federal_withholding(
            0, "Biweekly", self._default_w4_data(), 0, 0,
            self._default_fica(), ANNUAL_BRACKETS["Single"],
        )
    ...
    def test_extra_withholding(self):
        ...
        self.assertAlmostEqual(
            r_extra["federal_income_tax"] - r_base["federal_income_tax"], 50, places=2,
        )
    ...
    def test_head_of_household(self):
        ...
        fica = self._default_fica()
        single = calculate_federal_withholding(
            2000, "Biweekly", self._default_w4_data(), 0, 0, fica, ANNUAL_BRACKETS["Single"],
        )
        hoh_w4 = self._default_w4_data()
        hoh_w4["filing_status"] = "Head of Household"
        hoh = calculate_federal_withholding(
            2000, "Biweekly", hoh_w4, 0, 0, fica, ANNUAL_BRACKETS["Head of Household"],
        )
    ...
    def test_all_periods(self):
        ...
        for period in PERIODS_PER_YEAR:
            result = calculate_federal_withholding(
                5000, period, w4, 0, 0, fica, brackets,
            )
    ...
    def test_empty_brackets(self):
        ...
        result = calculate_federal_withholding(
            3000, "Biweekly", self._default_w4_data(), 0, 0,
            self._default_fica(), [],
        )
        self.assertEqual(result["federal_income_tax"], 0)
