...
SHIPPED_TEMPLATES = (
	{
		...
		"required_fields": [
			{"fieldname": "ticket_number", "label_en": "Ticket Number", "label_es": "Número de Boleta", "type": "text", "required": True},
			{"fieldname": "net_weight", "label_en": "Net Weight", "label_es": "Peso Neto", "type": "number", "required": True},
			{"fieldname": "weight_uom", "label_en": "Weight UOM", "label_es": "Unidad de Peso", "type": "text", "required": True},
			{"fieldname": "variety", "label_en": "Variety", "label_es": "Variedad", "type": "text"},
			{"fieldname": "grade", "label_en": "Grade", "label_es": "Grado", "type": "text"},
			{"fieldname": "weighed_on", "label_en": "Weighed On", "label_es": "Fecha de Pesaje", "type": "date"},
		],
	...
	},
	{
		...
		"required_fields": [
			{"fieldname": "delivered_to", "label_en": "Delivered To", "label_es": "Entregado A", "type": "text", "required": True},
			{"fieldname": "delivered_on", "label_en": "Delivered On", "label_es": "Fecha de Entrega", "type": "date", "required": True},
			{"fieldname": "received_by", "label_en": "Received By", "label_es": "Recibido Por", "type": "text", "required": True},
			{"fieldname": "packages", "label_en": "Packages", "label_es": "Bultos", "type": "number"},
			{"fieldname": "condition_on_arrival", "label_en": "Condition on Arrival", "label_es": "Condición al Llegar", "type": "long_text", "help": "Any damage, temperature excursion or short count, in the receiver's words."},
		],
	},
	{
		...
		"required_fields": [
			{"fieldname": "invoice_number", "label_en": "Invoice Number", "label_es": "Número de Factura", "type": "text", "required": True},
			{"fieldname": "invoice_date", "label_en": "Invoice Date", "label_es": "Fecha de Factura", "type": "date", "required": True},
			{"fieldname": "seller", "label_en": "Seller", "label_es": "Vendedor", "type": "text", "required": True},
			{"fieldname": "buyer", "label_en": "Buyer", "label_es": "Comprador", "type": "text", "required": True},
			{"fieldname": "currency", "label_en": "Currency", "label_es": "Moneda", "type": "text", "required": True},
			{"fieldname": "total_value", "label_en": "Total Value", "label_es": "Valor Total", "type": "number", "required": True},
			{"fieldname": "incoterms", "label_en": "Incoterms", "label_es": "Incoterms", "type": "text", "help": "FOB, CIF, DDP — who bears cost and risk to where. A customs value is read differently under each."},
			{"fieldname": "country_of_origin", "label_en": "Country of Origin", "label_es": "País de Origen", "type": "text"},
			{"fieldname": "harmonized_code", "label_en": "Harmonized Code", "label_es": "Código Arancelario", "type": "text", "help": "HS heading for the commodity. 0809.29 is sweet cherries, fresh."},
		],
	},
	{
		...
		"sequence": 40,
		"required_fields": [
			{"fieldname": "grade", "label_en": "Grade", "label_es": "Grado", "type": "text", "required": True},
			{"fieldname": "grading_standard", "label_en": "Grading Standard", "label_es": "Norma de Clasificación", "type": "text", "required": True},
			{"fieldname": "size", "label_en": "Size", "label_es": "Calibre", "type": "text"},
			{"fieldname": "graded_by", "label_en": "Graded By", "label_es": "Clasificado Por", "type": "text"},
			{"fieldname": "graded_on", "label_en": "Graded On", "label_es": "Fecha de Clasificación", "type": "date"},
			{"fieldname": "defects", "label_en": "Defects Noted", "label_es": "Defectos Anotados", "type": "long_text"},
		],
	},
	{
		...
		"required_fields": [
			{"fieldname": "certificate_number", "label_en": "Certificate Number", "label_es": "Número de Certificado", "type": "text", "required": True},
			{"fieldname": "grade", "label_en": "Grade", "label_es": "Grado", "type": "text", "required": True},
			{"fieldname": "inspection_point", "label_en": "Inspection Point", "label_es": "Punto de Inspección", "type": "text", "required": True},
			{"fieldname": "inspector_name", "label_en": "Inspector", "label_es": "Inspector", "type": "text", "required": True},
			{"fieldname": "inspected_on", "label_en": "Inspected On", "label_es": "Fecha de Inspección", "type": "date", "required": True},
			{"fieldname": "lot_identification", "label_en": "Lot Identification", "label_es": "Identificación del Lote", "type": "text"},
		],
	...
	},
	{
		...
		"sequence": 35,
		"required_fields": [
			{"fieldname": "total_packages", "label_en": "Total Packages", "label_es": "Total de Bultos", "type": "number", "required": True},
			{"fieldname": "package_type", "label_en": "Package Type", "label_es": "Tipo de Empaque", "type": "text", "required": True},
			{"fieldname": "gross_weight", "label_en": "Gross Weight", "label_es": "Peso Bruto", "type": "number", "required": True},
			{"fieldname": "net_weight", "label_en": "Net Weight", "label_es": "Peso Neto", "type": "number", "required": True},
			{"fieldname": "pallet_count", "label_en": "Pallet Count", "label_es": "Número de Tarimas", "type": "number"},
			{"fieldname": "marks_and_numbers", "label_en": "Marks and Numbers", "label_es": "Marcas y Números", "type": "long_text"},
			{"fieldname": "lot_codes", "label_en": "Lot Codes", "label_es": "Códigos de Lote", "type": "long_text", "help": "What a recall is traced by. The single most useful line on this document."},
		],
	},
	{
		...
		"description_es": (
			"El recibo del transportista y el contrato de transporte. Nombrado según el modelo "
			"de datos DCSA."
		),
		"tiers": "Domestic, International",
		"sequence": 50,
		...
		"required_fields": [
			{"fieldname": "transport_document_reference", "label_en": "Transport Document Reference", "label_es": "Referencia del Documento de Transporte", "type": "text", "required": True},
			{"fieldname": "shipper", "label_en": "Shipper", "label_es": "Expedidor", "type": "text", "required": True},
			{"fieldname": "consignee", "label_en": "Consignee", "label_es": "Consignatario", "type": "text", "required": True},
			{"fieldname": "notify_party", "label_en": "Notify Party", "label_es": "Parte a Notificar", "type": "text"},
			{"fieldname": "carrier", "label_en": "Carrier", "label_es": "Transportista", "type": "text", "required": True},
			{"fieldname": "place_of_receipt", "label_en": "Place of Receipt", "label_es": "Lugar de Recepción", "type": "text"},
			{"fieldname": "port_of_loading", "label_en": "Port of Loading", "label_es": "Puerto de Carga", "type": "text"},
			{"fieldname": "port_of_discharge", "label_en": "Port of Discharge", "label_es": "Puerto de Descarga", "type": "text"},
			{"fieldname": "vessel", "label_en": "Vessel", "label_es": "Buque", "type": "text"},
			{"fieldname": "voyage_number", "label_en": "Voyage Number", "label_es": "Número de Viaje", "type": "text"},
			{"fieldname": "container_numbers", "label_en": "Container Numbers", "label_es": "Números de Contenedor", "type": "long_text"},
			{"fieldname": "freight_terms", "label_en": "Freight Terms", "label_es": "Términos de Flete", "type": "text"},
		],
	},
	{
		...
		"required_fields": [
			{"fieldname": "traceability_lot_code", "label_en": "Traceability Lot Code", "label_es": "Código de Lote de Trazabilidad", "type": "text", "required": True},
			{"fieldname": "growing_location", "label_en": "Growing Location", "label_es": "Lugar de Cultivo", "type": "text", "required": True},
			{"fieldname": "harvest_date", "label_en": "Harvest Date", "label_es": "Fecha de Cosecha", "type": "date", "required": True},
			{"fieldname": "packing_location", "label_en": "Packing Location", "label_es": "Lugar de Empaque", "type": "text", "required": True},
			{"fieldname": "shipped_from", "label_en": "Shipped From", "label_es": "Enviado Desde", "type": "text", "required": True},
			{"fieldname": "shipped_to", "label_en": "Shipped To", "label_es": "Enviado A", "type": "text", "required": True},
			{"fieldname": "traceability_contact", "label_en": "Traceability Contact", "label_es": "Contacto de Trazabilidad", "type": "text", "required": True, "help": "A name and a phone number somebody answers. A record naming a department is a record that fails a timed exercise."},
		],
	},
	{
		...
		"sequence": 65,
		"required_fields": [
			{"fieldname": "set_point_c", "label_en": "Set Point (°C)", "label_es": "Punto de Ajuste (°C)", "type": "number", "required": True},
			{"fieldname": "pulp_temperature_at_loading_c", "label_en": "Pulp Temperature at Loading (°C)", "label_es": "Temperatura de Pulpa al Cargar (°C)", "type": "number", "required": True},
			{"fieldname": "loaded_at", "label_en": "Loaded At", "label_es": "Hora de Carga", "type": "datetime", "required": True},
			{"fieldname": "recorder_id", "label_en": "Recorder ID", "label_es": "ID del Registrador", "type": "text", "help": "The datalogger travelling with the load."},
			{"fieldname": "excursions", "label_en": "Excursions", "label_es": "Excursiones", "type": "long_text", "help": "Every time the load left its range, with when and for how long. 'None' is an answer; blank is not."},
			{"fieldname": "precooling_method", "label_en": "Precooling Method", "label_es": "Método de Preenfriado", "type": "text"},
		],
	},
	{
		...
		"required_fields": [
			{"fieldname": "certificate_number", "label_en": "Certificate Number", "label_es": "Número de Certificado", "type": "text", "required": True},
			{"fieldname": "exporting_country", "label_en": "Exporting Country", "label_es": "País Exportador", "type": "text", "required": True},
			{"fieldname": "importing_country", "label_en": "Importing Country", "label_es": "País Importador", "type": "text", "required": True},
			{"fieldname": "botanical_name", "label_en": "Botanical Name", "label_es": "Nombre Botánico", "type": "text", "required": True, "help": "Prunus avium for sweet cherry. The common name is not what a plant-health authority reads."},
			{"fieldname": "place_of_origin", "label_en": "Place of Origin", "label_es": "Lugar de Origen", "type": "text", "required": True},
			{"fieldname": "declared_quantity", "label_en": "Declared Quantity", "label_es": "Cantidad Declarada", "type": "text", "required": True},
			{"fieldname": "distinguishing_marks", "label_en": "Distinguishing Marks", "label_es": "Marcas Distintivas", "type": "text"},
			{"fieldname": "additional_declaration", "label_en": "Additional Declaration", "label_es": "Declaración Adicional", "type": "long_text", "help": "The wording the importing country demands verbatim. A paraphrase is a rejected certificate."},
			{"fieldname": "treatment", "label_en": "Treatment", "label_es": "Tratamiento", "type": "text"},
			{"fieldname": "treatment_chemical", "label_en": "Treatment Chemical", "label_es": "Producto del Tratamiento", "type": "text"},
			{"fieldname": "treatment_duration_and_temperature", "label_en": "Duration and Temperature", "label_es": "Duración y Temperatura", "type": "text"},
			{"fieldname": "treatment_date", "label_en": "Treatment Date", "label_es": "Fecha del Tratamiento", "type": "date"},
			{"fieldname": "pest_declarations", "label_en": "Pest Declarations", "label_es": "Declaraciones de Plagas", "type": "long_text"},
			{"fieldname": "inspection_date", "label_en": "Inspection Date", "label_es": "Fecha de Inspección", "type": "date"},
		],
		"notes": (
	...
	},
	{
		...
		"required_fields": [
			{"fieldname": "exporter", "label_en": "Exporter", "label_es": "Exportador", "type": "text", "required": True},
			{"fieldname": "manufacturer", "label_en": "Producer or Manufacturer", "label_es": "Productor o Fabricante", "type": "text", "required": True},
			{"fieldname": "consignee", "label_en": "Consignee", "label_es": "Consignatario", "type": "text", "required": True},
			{"fieldname": "country_of_origin", "label_en": "Country of Origin", "label_es": "País de Origen", "type": "text", "required": True},
			{"fieldname": "harmonized_code", "label_en": "Harmonized Code", "label_es": "Código Arancelario", "type": "text", "required": True},
			{"fieldname": "origin_criterion", "label_en": "Origin Criterion", "label_es": "Criterio de Origen", "type": "text", "required": True, "help": "Wholly obtained, substantial transformation, or the agreement's own lettered criterion. Fruit grown and picked on the farm is wholly obtained."},
			{"fieldname": "trade_agreement", "label_en": "Trade Agreement", "label_es": "Acuerdo Comercial", "type": "text"},
			{"fieldname": "issuing_body", "label_en": "Issuing Body", "label_es": "Organismo Emisor", "type": "text", "help": "A chamber of commerce, where the destination requires a chambered certificate rather than a self-declaration."},
		],
	},
	{
		...
		"external_system": "AES",
		"required_fields": [
			{"fieldname": "itn", "label_en": "Internal Transaction Number (ITN)", "label_es": "Número de Transacción Interna (ITN)", "type": "text", "required": True, "help": "What AES returns on acceptance. The carrier will ask for it."},
			{"fieldname": "usppi", "label_en": "US Principal Party in Interest", "label_es": "Parte Principal Estadounidense", "type": "text", "required": True},
			{"fieldname": "usppi_ein", "label_en": "USPPI EIN", "label_es": "EIN de la USPPI", "type": "text", "required": True},
			{"fieldname": "ultimate_consignee", "label_en": "Ultimate Consignee", "label_es": "Consignatario Final", "type": "text", "required": True},
			{"fieldname": "consignee_type", "label_en": "Consignee Type", "label_es": "Tipo de Consignatario", "type": "text"},
			{"fieldname": "schedule_b_number", "label_en": "Schedule B Number", "label_es": "Número Schedule B", "type": "text", "required": True, "help": "The 10-digit US export commodity classification. 0809.29.0000 is fresh sweet cherries."},
			{"fieldname": "eccn", "label_en": "ECCN", "label_es": "ECCN", "type": "text", "help": "EAR99 for most agricultural goods."},
			{"fieldname": "license_code", "label_en": "License Code", "label_es": "Código de Licencia", "type": "text", "help": "C33 / NLR where no licence is required."},
			{"fieldname": "port_of_export", "label_en": "Port of Export", "label_es": "Puerto de Exportación", "type": "text", "required": True},
			{"fieldname": "country_of_ultimate_destination", "label_en": "Country of Ultimate Destination", "label_es": "País de Destino Final", "type": "text", "required": True},
			{"fieldname": "value", "label_en": "Value", "label_es": "Valor", "type": "number", "required": True},
			{"fieldname": "export_date", "label_en": "Export Date", "label_es": "Fecha de Exportación", "type": "date"},
			{"fieldname": "routed_transaction", "label_en": "Routed Transaction", "label_es": "Transacción Enrutada", "type": "checkbox", "help": "Whether the foreign buyer engaged the forwarder. It moves who is responsible for filing."},
		],
	...
	},
	{
		...
		"required_fields": [
			{"fieldname": "certificate_number", "label_en": "Certificate Number", "label_es": "Número de Certificado", "type": "text", "required": True},
			{"fieldname": "fumigant", "label_en": "Fumigant", "label_es": "Fumigante", "type": "text", "required": True},
			{"fieldname": "dosage", "label_en": "Dosage", "label_es": "Dosis", "type": "text", "required": True},
			{"fieldname": "duration_hours", "label_en": "Duration (hours)", "label_es": "Duración (horas)", "type": "number", "required": True},
			{"fieldname": "temperature_c", "label_en": "Temperature (°C)", "label_es": "Temperatura (°C)", "type": "number", "required": True},
			{"fieldname": "treatment_date", "label_en": "Treatment Date", "label_es": "Fecha del Tratamiento", "type": "date", "required": True},
			{"fieldname": "treatment_location", "label_en": "Treatment Location", "label_es": "Lugar del Tratamiento", "type": "text"},
	...
	},
	{
		...
		"required_fields": [
			{"fieldname": "transport_document_reference", "label_en": "Transport Document Reference", "label_es": "Referencia del Documento de Transporte", "type": "text", "required": True},
			{"fieldname": "platform", "label_en": "eBL Platform", "label_es": "Plataforma eBL", "type": "text", "required": True},
			{"fieldname": "shipper", "label_en": "Shipper", "label_es": "Expedidor", "type": "text", "required": True},
			{"fieldname": "consignee", "label_en": "Consignee", "label_es": "Consignatario", "type": "text", "required": True},
			{"fieldname": "notify_party", "label_en": "Notify Party", "label_es": "Parte a Notificar", "type": "text"},
			{"fieldname": "carrier", "label_en": "Carrier", "label_es": "Transportista", "type": "text", "required": True},
			{"fieldname": "vessel", "label_en": "Vessel", "label_es": "Buque", "type": "text"},
			{"fieldname": "voyage_number", "label_en": "Voyage Number", "label_es": "Número de Viaje", "type": "text"},
			{"fieldname": "port_of_loading", "label_en": "Port of Loading", "label_es": "Puerto de Carga", "type": "text", "required": True},
			{"fieldname": "port_of_discharge", "label_en": "Port of Discharge", "label_es": "Puerto de Descarga", "type": "text", "required": True},
			{"fieldname": "container_numbers", "label_en": "Container Numbers", "label_es": "Números de Contenedor", "type": "long_text"},
			{"fieldname": "shipped_on_board_date", "label_en": "Shipped On Board Date", "label_es": "Fecha de Embarque", "type": "date"},
			{"fieldname": "is_to_order", "label_en": "To Order", "label_es": "A la Orden", "type": "checkbox", "help": "A to-order eBL is negotiable. Whoever holds it holds the goods."},
		],
	...
	},
	{
		...
		"sequence": 95,
		"required_fields": [
			{"fieldname": "permit_number", "label_en": "Permit Number", "label_es": "Número de Permiso", "type": "text", "required": True},
			{"fieldname": "issuing_authority", "label_en": "Issuing Authority", "label_es": "Autoridad Emisora", "type": "text", "required": True},
			{"fieldname": "permit_holder", "label_en": "Permit Holder", "label_es": "Titular del Permiso", "type": "text", "required": True},
			{"fieldname": "valid_from", "label_en": "Valid From", "label_es": "Válido Desde", "type": "date"},
			{"fieldname": "valid_to", "label_en": "Valid To", "label_es": "Válido Hasta", "type": "date", "help": "Set the document's own expires_on to this. An expired permit is reported as not satisfied, which is the point."},
			{"fieldname": "permitted_commodity", "label_en": "Permitted Commodity", "label_es": "Producto Autorizado", "type": "text"},
			{"fieldname": "conditions", "label_en": "Conditions", "label_es": "Condiciones", "type": "long_text"},
		],
	},
	{
		...
		"sequence": 100,
		"required_fields": [
			{"fieldname": "policy_number", "label_en": "Policy Number", "label_es": "Número de Póliza", "type": "text", "required": True},
			{"fieldname": "insurer", "label_en": "Insurer", "label_es": "Aseguradora", "type": "text", "required": True},
			{"fieldname": "insured_value", "label_en": "Insured Value", "label_es": "Valor Asegurado", "type": "number", "required": True},
			{"fieldname": "coverage", "label_en": "Coverage", "label_es": "Cobertura", "type": "text", "help": "Institute Cargo Clauses A, B or C."},
			{"fieldname": "claims_agent", "label_en": "Claims Agent at Destination", "label_es": "Agente de Reclamos en Destino", "type": "text"},
		],
	},
)
